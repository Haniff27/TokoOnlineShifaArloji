...
<?php
    $id=$_GET['id'];
    $query="SELECT * FROM tbl_service WHERE id_service='$id'";
...
<div class="container bg-white rounded pt-4 pb-4" id="containt">
    <div class="row">
        <div class="col-md-5 col-sm-12">
            <div class="itemBig">
                <a href="admin/assets/images/foto_service/<?php echo $service['gambar'];?>">
                    <img src="admin/assets/images/foto_service/<?php echo $service['gambar'];?>" height="400px"
                        width="100%">
                </a>
            </div>
        </div>
        <div class="col-md-7 col-sm-12 pt-3 pl-5">
            <h3><?php echo $service['nm_service']; ?></h3>
            ...
            <h3 class="text-danger"><span class="text-secondary" style="font-size: 15px">Harga :
                </span>Rp. <?php echo number_format($service['harga']); ?></h3>
            <br>
            <p class="text-secondary font-weight-bold"><i class="fa fa-stop-circle-o text-success"
                    aria-hidden="true"></i>
                Stok Tersedia</p>
            <p class="text-danger">Tersisa <?php echo number_format($service['stok']); ?> Unit (segera lakukan
                pembelian)</p>
                ...
                <div class="row">
                    <div class="col-3">
                        ...
                        <!-- <input id="demo0" type="text" value="1" name="demo0" data-bts-min="1"
                                data-bts-max="<?php echo $service['stok']; ?>" class="text-center" /> -->
                        <div class="input-group spinner">
                            ...
                            <input type="text" name="stok" id="qty_input" class="form-control input-number text-center"
                                value="1" min="1" max="<?php echo $service['stok']; ?>">
                            <button type="button" class="btn btn-primary btn-number pl-2 pr-2"
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-5">
                        <button class="btn btn-primary btn-block ml-3" name="beli2">
                            <i class="fa fa-shopping-cart" aria-hidden="true"></i> Pesan Sekarang
                        </button>
                    </div>
                </div>
        </div>
        ...
        <?php
                if (isset($_POST['beli'])) {
                    ...
                    if (isset($_SESSION['cart_service'][$id])) {
                        $_SESSION['cart_service'][$id]+=$jumlah;
                    }
                    else {
                        $_SESSION['cart_service'][$id] = $jumlah;
                    }
                    echo "<script type='text/javascript'>swal('','Barang Sudah Masuk Ke Keranjang Belanja', 'success');</script>";
                }
                elseif (isset($_POST['beli2'])) {
                    ...
                    echo "<script>location='cart-service.php';</script>";
                }
            ?>
    </div>
    <br>
    <hr>
    <div class="BarangDesc">
        <div class="row">
            <div class="col-md-2">
        ...
        <div class="row">
            <div class="col-md-12 bg-light">
                <div class="dec pt-5 pl-5 pr-5 text-justify">
                    <h5>Spesifikasi Dan Deskripsi Barang :</h5>
