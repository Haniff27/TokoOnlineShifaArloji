...
<div class="content">
    <div class="container">
        <?php
            $query0 = "SELECT * FROM tbl_kat_artikel";
        ...
        if (isset($_POST['post']))
        {
            ...
            { 
                //memindah file gambar dari file temporari ke folder assets/images/foto_/
                move_uploaded_file($lokasi, "assets/images/foto_artikel/" . $nmGambar);
                //Memasukkan data ke tabel tbl_
                ...
                <div class="col-4">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <button type="submit" class="btn btn-success waves-effect waves-light mt-3" name="post">Posting Artikel</button>
                        </div>
                    </div>
                </div>
            </div>
