...
<div class="content">
    <div class="container bg-white rounded pb-4 pt-4">
        ...
        if (isset($_GET['id'])) {
            ...
            echo "<script type='text/javascript'>swal('Dihapus!', 'barang Berhasil Dihapus Dari Keranjang', 'success');</script>";
        }
        ?>
        <div class="row">
            <div class="col-12">
                        ...
                        if (empty($_SESSION["cart"])) {
                            echo "<script type='text/javascript'>
                                swal({
                                    ...
                                    text: 'Silahkan Memilih barang Dahulu!',
                                    icon: 'warning',
                                    dangerMode: true,
                                }).then(okay => {
                                    if (okay) {
                                                ...
                                                swal({
                                                    ...
                                                    if (willDelete) {
                                                        window.location.href =
                                                            "cart.php?id=<?php echo $barang['id_barang']; ?>";
                                                    }
                                                    /* else {
