...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="assets/img/icon/projek1.png">
        ...
        <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-white m-0 p-0">
            <div class="container pl-3 pr-3">
                <a class=" navbar-brand" href="#">
                    <img src="assets/img/icon/toko.png" width="100" height="30" alt="">
                </a>
                ...
                <div class="collapse navbar-collapse  justify-content-center" id="navbarNavDropdown">
                    <ul class="navbar-nav">
                        ...
                        <?php if (isset($_SESSION["pelanggan"])) { ?>
                            <li class="nav-item dropdown">
                                <a class="nav-link" href="#" role="button" id="dropdownMenu2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    Service
                                </a>
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="service.php">Service</a>
                                    <a class="dropdown-item" href="cart-service.php">Keranjang Service</a>
                                    <a class="dropdown-item" href="orderan-service.php">Riwayat Service</a>
                                </div>
                            </li>
                        <?php }
                        ?>
