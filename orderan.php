                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                echo $data2['jml'];
                                ?> Barang | <a href="rincian-barang.php?id=<?php echo $id_order; ?>" class="badge badge-info">Lihat</a>
                            </td>
                            ...
                            <td class="text-left">
                                ...
                                <?php } elseif ($data['status'] == 'Barang Dikirim') { ?>
                                    <a href="nota-order.php?id=<?php echo $id_order; ?>" class="btn btn-secondary btn-sm">Nota</a>
                                ...
                                <?php } elseif ($data['status'] == 'Barang Diterima') { ?>
                                    <a href="nota-order.php?id=<?php echo $id_order; ?>" class="btn btn-secondary btn-sm">Nota</a>
                                <?php } ?>
                            </td>
                        </tr>
