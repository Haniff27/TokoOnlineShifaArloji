        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="text-muted m-b-30 font-14">Lihat <a href="cart.php" style="text-decoration: none;">detail</a> detail
                                    keranjang belanja</p>
                ...
                if (isset($_POST['pesan'])) {
                    ...
                    //simpat detail_order
                    foreach ($_SESSION['cart'] as $id_barang2 => $jumlah2) {
                        //mendapatkan data barang berdasarkan id_barang
                        $ambil = "SELECT * FROM tbl_barang WHERE id_barang='$id_barang2'";
                        ...
                        $query3 = "INSERT INTO tbl_detail_order (id_order,id_barang,nm_barang,harga,jml_order,berat,subberat,subharga)
                            VALUES ('$id_order_barusan','$id_barang2', '$nmbarang','$harga','$jumlah2','$berat','$subberat2','$subharga2' )";
                        $result3 = mysqli_query($db, $query3);

                        //update stok
                        $query4 = "UPDATE tbl_barang SET stok=stok-$jumlah2 WHERE id_barang='$id_barang2'";
