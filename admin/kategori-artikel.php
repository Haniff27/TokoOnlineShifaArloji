...
if (isset($_GET['id']))
{
    ...
    $id = $_GET['id'];
    //menghapus data
    $queryHapus = "DELETE FROM tbl_kat_artikel WHERE id_kategori='$id'";
    ...
    if ($execHapus)
    {
        ...
        echo "<script>location='index.php?pages=kategori-artikel';</script>";
    }
}
?>
<div class="row">
            ...
            <div class="card-body">
                ...
                <?php
                    if(isset($_POST['tambah'])){
                        $nm = $_POST['nama'];
                        $insert = "INSERT INTO tbl_kat_artikel (nm_kategori) VALUES ('$nm')";
        ...
        <div class="card m-b-20">
            <div class="card-body">
                <form>
                    <div class="row">
                        <div class="col-sm-12">
                            <label for="productname">Kategori Artikel</label><br>
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th scope="col">No</th>
                                ...
                                <tbody>
                                    <?php $no=1; ?>
                                    <?php $ambil=$db->query("SELECT * FROM tbl_kat_artikel"); ?>
                                    <?php while($pecah=$ambil->fetch_assoc()){ ?>
                                    <tr>
                                        <th scope="row"><?php echo $no; ?></th>
                                        <td><?php echo $pecah['nm_kategori'] ?></td>
                                        <td>
                                            <a href="index.php?pages=kategori-artikel&id=<?php echo $pecah['id_kategori']; ?>"
