...
<div class="banner mb-5">
    <div class="container-fluid img">
        <div class="container-fluid box">
            <h3>KONFIRMASI PEMBAYARAN SERVICE</h3>
                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="<?= $_SESSION['pelanggan']['nm_pelanggan'] ?>" name="nama" required="required">
                            </div>
                            <div class="form-group">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body alert-danger">
                        ...
                        Minimal DP : <strong>Rp. <?php echo number_format($data["total_order"] * 0.5) ?> <br>
...
if (isset($_POST['kirim'])) {
    ...
    } elseif (!empty($lokasi)) //Jika temporari tidak kosong 
    {
        ...
        move_uploaded_file($lokasi, "assets/img/bukti-transfer-service/" . $nmGambar);
        //Memasukkan data ke tabel tbl_Barang
        $query = "INSERT INTO tbl_pembayaran_service (id_orderservice,nm_pembayar,nm_bank,jml_pembayaran,tgl_bayar,bukti_transfer)
                                        VALUE('$id', '$nama', '$bank', '$jml', '$tgl','$nmGambar')";
        $exec = mysqli_query($db, $query);

        //ubah status orderan
        $qupdate = "UPDATE tbl_order_service SET status='Sudah Dibayar' WHERE id_orderservice='$id'";
        ...
        echo "<script type='text/javascript'>
                                            swal({
                                                ...
                                                text: 'Barang Segera Kami Persiapkan Untuk Dikirim',
                                                icon: 'success',
                                                button: false
                                            });
                                            </script>";
        echo "<meta http-equiv='refresh' content='1;url=orderan-service.php'>";
