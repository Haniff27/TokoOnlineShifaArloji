...
<div class="content">
    <div class="container">
        <?php 
            $id = $_GET['id'];
            $panggil = "SELECT * FROM tbl_artikel WHERE id_artikel='$id' ";
            $resultpanggil = mysqli_query($db, $panggil);
            $dataPos = mysqli_fetch_assoc($resultpanggil);

            $queryKat = "SELECT * FROM tbl_kat_artikel";
        ...
        if (isset($_POST['ubah']))
        {
            ...
            if (!empty($lokasi)) {
                move_uploaded_file($lokasi, "assets/images/foto_artikel/$nmGambar");

                $queryEdit = "UPDATE tbl_artikel SET id_kategori='$kategori', judul='$judul', isi='$isi', gambar='$nmGambar', tgl='$tgl' WHERE id_artikel='$id'";
                $resultEdit = mysqli_query($db, $queryEdit);
            }
            else {
                $queryEdit = "UPDATE tbl_artikel SET id_kategori='$kategori', judul='$judul', isi='$isi', tgl='$tgl' WHERE id_pos='$id'";
                $resultEdit = mysqli_query($db, $queryEdit);
            }
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
								...
								<?php if($dataPos['gambar']!=null):?>
									<img src="assets/images/foto_artikel/<?php echo $dataPos['gambar']; ?>" alt="pos img" class="img-fluid"
