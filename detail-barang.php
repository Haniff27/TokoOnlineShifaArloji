...
<div class="container bg-white rounded pt-4 pb-4" id="containt">
    <div class="row">
        <div class="col-md-5 col-sm-12">
            <div class="itemBig">
                <a href="admin/assets/images/foto_barang/<?php echo $barang['gambar'];?>">
                    <img src="admin/assets/images/foto_barang/<?php echo $barang['gambar'];?>" height="400px"
                        width="100%">
                </a>
            </div>
        </div>
        <div class="col-md-7 col-sm-12 pt-3 pl-5">
            <h3><?php echo $barang['nm_barang']; ?></h3>
            ...
            <h3 class="text-danger"><span class="text-secondary" style="font-size: 15px">Harga :
                </span>Rp. <?php echo number_format($barang['harga']); ?></h3>
            <br>
            <p class="text-secondary font-weight-bold"><i class="fa fa-stop-circle-o text-success"
                    aria-hidden="true"></i>
                Stok Tersedia</p>
            <p class="text-danger">Tersisa <?php echo number_format($barang['stok']); ?> Unit (segera lakukan
                pembelian)</p>
                ...
                <div class="row">
                    <div class="col-3">
                        ...
                        <!-- <input id="demo0" type="text" value="1" name="demo0" data-bts-min="1"
                                data-bts-max="<?php echo $barang['stok']; ?>" class="text-center" /> -->
                        <div class="input-group spinner">
                            ...
                            <input type="text" name="stok" id="qty_input" class="form-control input-number text-center"
                                value="1" min="1" max="<?php echo $barang['stok']; ?>">
                            <button type="button" class="btn btn-primary btn-number pl-2 pr-2"
