...
<?php
	$query = "SELECT * FROM tbl_kat_barang";
...
if (isset($_POST['tambah']))
{
    ...
    { 
		//memindah file gambar dari file temporari ke folder assets/images/foto_barang/
		move_uploaded_file($lokasi, "assets/images/foto_barang/" . $nmGambar);
		//Memasukkan data ke tabel tbl_barang
        $query_add = "INSERT INTO tbl_barang
                (id_kategori,nm_barang,berat,harga,stok,gambar,deskripsi)
				VALUE('$kategori', '$nmbarang', '$berat', '$harga', '$stok','$nmGambar', '$deskripsi')";
        ...
        echo "<p class='alert alert-success' role='alert'>
                Berhasil Menambahkan Data barang.<br />
                <a href='index.php?pages=barang'>Lihat Semua Barang</a>
                </p>";
    }
			...
			<div class="card-body">
				<form method="post" enctype="multipart/form-data">
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="form-group">
								<label>Masukkan Gambar barang</label>
