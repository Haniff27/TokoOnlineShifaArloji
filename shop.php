...
<div class="container">
    ...
    if (isset($_GET['kategori'])) {
        ...
        $query = "SELECT * FROM tbl_barang WHERE id_kategori='$kategori'";
    }
    /* elseif (isset($_GET['urut'])) {
        ...
        elseif ($urut == 'hurufA') {
             $query = "SELECT * FROM tbl_barang ORDER BY nm_barang asc";
        }
        elseif ($urut == 'hurufZ') {
            $query = "SELECT * FROM tbl_barang ORDER BY nm_barang desc";
        }
        elseif ($urut == 'murah') {
            $query = "SELECT * FROM tbl_barang ORDER BY harga asc";
        }
        elseif ($urut == 'mahal') {
            $query = "SELECT * FROM tbl_barang ORDER BY harga desc";
        }
    } */ elseif (isset($_GET['select'])) {
        $cari = $_GET['select'];
        $query = "SELECT * FROM tbl_barang WHERE nm_barang LIKE '%" . $cari . "%'ORDER BY id_barang asc";
    } else {
        $query = "SELECT * FROM tbl_barang p JOIN tbl_kat_barang k ON p.id_kategori=k.id_kategori ORDER BY id_barang asc";
    }
    ?>
    <div class="row">
        <div class="col-md-12 col-lg-4 col-xl-3">
            <div class="card pb-3">
                <div class="card-body" style="padding-bottom: 3px;">
                    ...
                    <?php
                    $qkat = "SELECT * FROM tbl_kat_barang";
            ...
            <div class="row">
                <div class="col-md-12 pl-5 text-secondary">
                    ...
                    echo "<h4><i>Diurutkan Berdasarkan : ".$cari."</i></h4>";
                        ...
                        $cari = $_GET['kategori'];
                        $query2 = "SELECT * FROM tbl_kat_barang WHERE id_kategori='$cari'";
