...
<div class="row">
    ...
    <div class="col-md-6 col-lg-4 col-xl-2">
        <div class="mini-stat clearfix bg-white">
            ...
            <div class="mini-stat-info">
                <h3 class="counter font-light mt-0"><?php echo number_format($menyiapkanBarang['jml']); ?></h3>
            </div>
            <div class="clearfix"></div>
            <p class=" mb-0 m-t-10 text-muted" style="font-size: small;">
                Menyiapkan Barang
    ...
    <div class="col-md-6 col-lg-4 col-xl-2">
        <div class="mini-stat clearfix bg-white">
            ...
            <div class="mini-stat-info">
                <h3 class="counter font-light mt-0"><?php echo number_format($barangDikirm['jml']); ?></h3>
            </div>
            <div class="clearfix"></div>
            <p class=" mb-0 m-t-10 text-muted" style="font-size: small;">
                Barang Dikirim
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php } elseif ($data['status']=='Menyiapkan Barang'){ ?>
                                <a href="index.php?pages=pembayaran&id=<?php echo $data['id_order']; ?>"
