        ...
        <div class="col-md-12">
            <table class="table">
                ...
                <tbody>
                    ...
                    $id = $_GET['id'];
                    $no = 1;
                    $sql = "SELECT * FROM tbl_detail_order d JOIN tbl_barang p ON d.id_barang=p.id_barang WHERE id_order = '$id'";
                        ...
                        <tr>
                            ...
                            <td class="product-list-img">
                                <?php if ($produk['gambar'] != null) : ?>
                                    <img width="40" src="admin/assets/images/foto_barang/<?php echo $produk['gambar'] ?>" class="img-fluid" alt="tbl">
                                <?php endif; ?>
                            </td>
                            <td><?php echo $produk['nm_barang']; ?></td>
